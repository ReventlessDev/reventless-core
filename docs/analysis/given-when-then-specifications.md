...
> file plus [`packages/doc/docs-app/given-when-then.md`](../../packages/doc/docs-app/given-when-then.md)).
...
> [`packages/doc/docs-app/given-when-then.md`](../../packages/doc/docs-app/given-when-then.md).
