...
- This repo: [`rescript-pulumi-pulumi/src/Rescript11Problem.res`](https://github.com/ReventlessDev/reventless-core/blob/main/rescript/pulumi-pulumi/src/Rescript11Problem.res) — original problem documentation with reproduction code
- This repo: [`rescript-pulumi-pulumi/src/Output.res`](https://github.com/ReventlessDev/reventless-core/blob/main/rescript/pulumi-pulumi/src/Output.res) lines 83-87 — earlier workaround attempt
