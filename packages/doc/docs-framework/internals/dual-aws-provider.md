...
- **Adapter** — [`AppSync_Resolver_Native.res`](https://github.com/ReventlessDev/reventless-core/blob/alpha/reventless/aws/src/adapter/Api/AppSync_Resolver_Native.res)
...
- **Wiring** — [`QueryDbResolvers_AppSync.res`](https://github.com/ReventlessDev/reventless-core/blob/alpha/reventless/aws/src/adapter/QueryDb/QueryDbResolvers_AppSync.res)
...
3. **Short-term workaround — reinstate a sleep.** Add a fixed wait after
   ...
   [`AppSync_Adapter.res`](https://github.com/ReventlessDev/reventless-core/blob/alpha/reventless/aws/src/components/Api/AppSync_Adapter.res)
