...
[Sury](https://github.com/DZakh/rescript-sury) is the serialization library used by Reventless for JSON encoding and decoding using a [PPX](/app/rescript-syntax#ppx).
