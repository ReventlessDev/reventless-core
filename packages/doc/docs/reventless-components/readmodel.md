...
A Read Model's business logic is defined by it's [**Spec**](#read-model-spec), [**Projections**](#projections) and [**Config**](../reventless-common-modules/config.md).
...
Finally the Read Model has to be generated by using the ReventlessAws.ReadModel.Make [functor](../rescript-syntax.md#functors) by providing the [Config](../reventless-common-modules/config.md), the [Read Model Spec](#read-model-spec) and the Mappings module.
