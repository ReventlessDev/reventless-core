...
:::note Migration
This documentation replaces the stub at [`packages/doc/docs/reventless-common-modules/counter.md`](../reventless-common-modules/counter.md). The Counter is a full component, not just a common module, and its primary use is within EventMappings for multi-event coordination patterns.
:::