...
This guide covers how to use StateChangeSlice in your Reventless application. For the component reference, see [StateChangeSlice](../reventless-components/statechangeslice.md).
...
- [StateChangeSlice Component Reference](../reventless-components/statechangeslice.md)
- [DCB Plugin Architecture](../../docs/dcb-plugin-usage.md)
- [DcbEventLog](../reventless-components/dcbeventlog.md)
- [CommandTopic](../reventless-components/commandtopic.md)
