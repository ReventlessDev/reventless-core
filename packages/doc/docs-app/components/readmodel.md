...
Finally the Read Model has to be generated by using the ReventlessAws.ReadModel.Make [functor](../rescript-syntax.md#functors) by providing the [Config](../common-modules/config.md), the [Read Model Spec](#read-model-spec) and the Mappings module.
