...
This component follows the Reventless [Component Structure Pattern](/framework/inner-workings/component-structure-pattern), using separate files for interface definitions ([`OutboundTranslationSlice.res`](../../reventless/reventless-core/src/components/OutboundTranslationSlice/OutboundTranslationSlice.res)), builder logic ([`OutboundTranslationSlice_Builder.res`](../../reventless/reventless-core/src/components/OutboundTranslationSlice/OutboundTranslationSlice_Builder.res)), and callback/handler logic ([`OutboundTranslationSlice_Callback.res`](../../reventless/reventless-core/src/components/OutboundTranslationSlice/OutboundTranslationSlice_Callback.res)).
:::
