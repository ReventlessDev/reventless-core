...
function Make(Target, EventCollector, Mappings) {
    ...
    return Belt_Array.map(actions, (function (x) {
                  switch (x.TAG | 0) {
                    ...
                    case /* PublishAsync */2 :
                        return {
                                TAG: /* Publisher */1,
                                _0: Js_promise.then_((function (cmds) {
  ...
  var commonEventsHandler = function (mappings, queryEngine, events$pJson) {
    ...
    var publisherEntries = Js_promise.then_((function (entries) {
  ...
  var eventCollectorEventsHandler = function (publishJsons, mappings, queryEngine, count, addToCounterTarget) {
    return function (events$pJson) {
      ...
      if (match$2 !== 0) {
        ...
        countP = Js_promise.$$catch((function (err) {
      ...
      var sendEntriesP = Js_promise.then_((function (commandJsons) {
  ...
  var counterEventsHandler = function (publishJsons, mappings, queryEngine) {
    return function (events$pJson) {
      ...
      return Js_promise.then_((function (commandJsons) {
                    return publishJsons(commandJsons);
                  }), match[0]);
    };
  };
