...
function Make(Config, Spec, Mappings, QueryDbStorage, QueryDbResolvers, EventCollectorConnector) {
  var construct = function (allEventTopics, self, name) {
    ...
    var eventsHandler = function (jsons) {
      ...
      var __x = Promise.all(Projection$Reventless.handleActions(actions, primitives, subIdConfig));
      return __x.then(function (results) {
                  ...
                  return Js_exn.raiseError("ReadModel.handleActions failed with " + count + " errors: " + errors);
                });
    };
