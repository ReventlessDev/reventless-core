...
function Make(Config, Spec, Behaviour, EventMappings, CommandGeneratorResolvers, CommandTopicConnector, EventLogStorage, EventTopicPublisher, EventCollectorConnector) {
  ...
  var handleCommands = function (param) {
    ...
    return async function (allTopicItems) {
      ...
      Logger$Reventless.debug("File \"Aggregate.res\", line 155, characters 22-29", undefined, undefined, "starting", "Aggregate.execCommands");
      return Belt_Array.concatMany(await Promise.all(Belt_Array.map(groupTopicItemsById(allTopicItems), (async function (param) {
                                ...
                                if (stateO !== undefined) {
                                  ...
                                  try {
                                    ...
                                    if ($$event.RE_EXN_ID === Message$Reventless.InvalidEvent) {
                                      Logger$Reventless.error("File \"Aggregate.res\", line 175, characters 34-41", undefined, undefined, "Behaviour.execute: InvalidEvent", $$event._1);
                                      generatedEvents = [];
                                    } else {
                                      throw $$event;
                                    }
                            ...
                            Logger$Reventless.debug("File \"Aggregate.res\", line 203, characters 26-33", undefined, undefined, "finished eventLogReplay for id", id);
                            Logger$Reventless.logCmdJsons("File \"Aggregate.res\", line 215, characters 34-41", undefined, Belt_Array.map(topicItems, (function (param) {
                            ...
                            if (events.length !== 0) {
                              ...
                              if (match$1.TAG === "Ok") {
                                Logger$Reventless.debug("File \"Aggregate.res\", line 253, characters 30-37", undefined, undefined, "finished eventLogAppend for id", Spec.Id.toString(id));
                              ...
                              Logger$Reventless.error("File \"Aggregate.res\", line 256, characters 30-37", undefined, undefined, "failed eventLogAppend for id", Spec.Id.toString(id));
                              return Belt_Array.map(references, (function (reference) {
                                            return {
                                                    TAG: "Error",
                                                    _0: reference
                            ...
                            Logger$Reventless.debug("File \"Aggregate.res\", line 239, characters 19-26", undefined, undefined, "handleCommands(" + Spec.Id.toString(id) + ")", "no Event generated");
                            return Belt_Array.map(references, (function (reference) {
                                          return {
                                                  TAG: "Ok",
                                                  _0: reference
