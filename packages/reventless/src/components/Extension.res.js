...
function Make(Spec, Mappings) {
  ...
  var mapOutgoingEvent = function (event$pJson, pluginDef) {
    ...
    if (mapOutgoingEvent$1 !== undefined) {
      ...
      Logger$Reventless.error("File \"Extension.res\", line 91, characters 15-22", undefined, undefined, "mapOutgoingEvent", "shouldn't be called, because Plugin EventCollector shouldn't subscribe to EventLog stream not having mapOutgoingEvent() !");
      return [];
    }
  };
