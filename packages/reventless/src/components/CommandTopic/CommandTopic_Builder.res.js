...
function Make(Spec, Channel) {
  ...
  var connect = function (runtime, resources, commandTopic) {
    var commandTopicResource = Component$Reventless.toPulumiResource(commandTopic);
    var name = ComponentType$Reventless.name(Core__Option.getOr(commandTopicResource.__name, "Unnamed"), CommandTopic$Reventless.componentType);
    var opts_parent = commandTopicResource;
    var opts = {
      parent: opts_parent
    };
