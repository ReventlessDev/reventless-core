...
function construct(self, name, availabilityZone) {
  ...
  var securityGroup = EC2_SecurityGroup$PulumiAws.make(name + "SecurityGroup", {
        ...
        vpcId: vpc.id,
        ingress: /* array */[EC2_SecurityGroup$PulumiAws.Args.Ingress.allowAll],
        egress: /* array */[EC2_SecurityGroup$PulumiAws.Args.Egress.allowAll]
      }, Caml_option.some(opts), /* () */0);
  var tmp = {
  ...
  var publicSubnet = EC2_Subnet$PulumiAws.make(name + "PublicSubnet", tmp, Caml_option.some(opts), /* () */0);
  var tmp$1 = {
  ...
  var privateSubnet = EC2_Subnet$PulumiAws.make(name + "PrivateSubnet", tmp$1, Caml_option.some(opts), /* () */0);
  ...
  var eip = EC2_Eip$PulumiAws.make(name + "Eip", {
        ...
        dependsOn: /* array */[internetGateway],
        parent: self
      }, /* () */0);
