...
function Make(Spec, Behaviour) {
  var errorHandler = function (error, command, context) {
    ...
    var id = context.id;
    Logger$Reventless.error("File \"Aggregate_Runtime.res\", line 11, characters 11-18", undefined, undefined, "Behaviour error " + errorJson + " in " + Spec.name + "(" + id + "): Command: ", commandJsonStr);
    return [];
  };
  var eventName = function (event$p) {
  ...
  var handleCommands = function (eventLogAppend, eventLogReplay) {
    return async function (allTopicItems) {
      ...
      Logger$Reventless.debug("File \"Aggregate_Runtime.res\", line 54, characters 24-31", undefined, undefined, "starting", "Aggregate.execCommands");
      return Belt_Array.concatMany(await Promise.all(Belt_Array.map(groupTopicItemsById(allTopicItems), (async function (param) {
                                ...
                                if (stateO !== undefined) {
                                  ...
                                  try {
                                    ...
                                    if ($$event.RE_EXN_ID === Message$Reventless.InvalidEvent) {
                                      Logger$Reventless.error("File \"Aggregate_Runtime.res\", line 77, characters 36-43", undefined, undefined, "Behaviour.execute: InvalidEvent", $$event._1);
                                      generatedEvents = [];
                                    } else {
                                      throw $$event;
                                    }
                            ...
                            Logger$Reventless.debug("File \"Aggregate_Runtime.res\", line 105, characters 28-35", undefined, undefined, "finished eventLogReplay for id", id);
                            Logger$Reventless.logCmdJsons("File \"Aggregate_Runtime.res\", line 117, characters 36-43", undefined, Belt_Array.map(topicItems, (function (param) {
                            ...
                            if (events.length !== 0) {
                              ...
                              if (match$1.TAG === "Ok") {
                                Logger$Reventless.debug("File \"Aggregate_Runtime.res\", line 155, characters 32-39", undefined, undefined, "finished eventLogAppend for id", Spec.Id.toString(id));
                              ...
                              Logger$Reventless.error("File \"Aggregate_Runtime.res\", line 158, characters 32-39", undefined, undefined, "failed eventLogAppend for id", Spec.Id.toString(id));
                              return Belt_Array.map(references, (function (reference) {
                                            return {
                                                    TAG: "Error",
                                                    _0: reference
                            ...
                            Logger$Reventless.debug("File \"Aggregate_Runtime.res\", line 141, characters 21-28", undefined, undefined, "handleCommands(" + Spec.Id.toString(id) + ")", "no Event generated");
                            return Belt_Array.map(references, (function (reference) {
                                          return {
                                                  TAG: "Ok",
                                                  _0: reference
  ...
  return {
          ...
          eventName: eventName,
          groupTopicItemsById: groupTopicItemsById,
