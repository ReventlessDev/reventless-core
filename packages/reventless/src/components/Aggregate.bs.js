...
function Make(Config, Spec, Behaviour, EventMappings, CommandGeneratorResolvers, CommandTopicConnector, EventLogStorage, EventTopicPublisher, EventCollectorConnector) {
  ...
  var handleCommands = function (param) {
    ...
    return async function (allTopicItems) {
      ...
      Logger$Reventless.debug("File \"Aggregate.res\", line 151, characters 22-29", undefined, undefined)("starting", "Aggregate.execCommands");
      return Belt_Array.concatMany(await Promise.all(Belt_Array.map(groupTopicItemsById(allTopicItems), (async function (param) {
                                ...
                                if (stateO !== undefined) {
                                  ...
                                  try {
                                    ...
                                    if ($$event.RE_EXN_ID === Message$Reventless.InvalidEvent) {
                                      Logger$Reventless.error("File \"Aggregate.res\", line 171, characters 34-41", undefined, undefined)("Behaviour.execute: InvalidEvent", $$event._1);
                                      generatedEvents = [];
                                    } else {
                                      throw $$event;
                                    }
                            ...
                            Logger$Reventless.debug("File \"Aggregate.res\", line 199, characters 26-33", undefined, undefined)("finished eventLogReplay for id", id);
                            Logger$Reventless.logCmdJsons("File \"Aggregate.res\", line 211, characters 34-41", undefined, Belt_Array.map(topicItems, (function (param) {
                            ...
                            if (events.length !== 0) {
                              ...
                              Logger$Reventless.debug(undefined, undefined, undefined)("Aggregate.handleCommands(" + Curry._1(Spec.Id.toString, id) + "): " + eventCount + " Event(s) generated:", Belt_Array.map(events, (function (event$p) {
                                          return Message$Reventless.variantNameOfJson(Curry._1(Spec.event_encode, event$p.event));
                                        })));
                              var match$1 = await eventLogAppend(history.length, id, events);
                              if (match$1.TAG === /* Ok */0) {
                                Logger$Reventless.debug("File \"Aggregate.res\", line 249, characters 30-37", undefined, undefined)("finished eventLogAppend for id", Curry._1(Spec.Id.toString, id));
                              ...
                              Logger$Reventless.error("File \"Aggregate.res\", line 252, characters 30-37", undefined, undefined)("failed eventLogAppend for id", Curry._1(Spec.Id.toString, id));
                              return Belt_Array.map(references, (function (reference) {
                                            return {
                                                    TAG: /* Error */1,
                                                    _0: reference
                            ...
                            Logger$Reventless.debug("File \"Aggregate.res\", line 235, characters 19-26", undefined, undefined)("handleCommands(" + Curry._1(Spec.Id.toString, id) + ")", "no Event generated");
                            return Belt_Array.map(references, (function (reference) {
                                          return {
                                                  TAG: /* Ok */0,
                                                  _0: reference
