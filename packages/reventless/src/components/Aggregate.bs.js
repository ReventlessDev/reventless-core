...
function Make(Config, Spec, Behaviour, EventMappings, CommandGeneratorResolvers, CommandTopicConnector, EventLogStorage, EventTopicPublisher, EventCollectorConnector) {
    ...
    return function (allTopicItems) {
      ...
      return Promise.all(Belt_Array.map(groupTopicItemsById(allTopicItems), (function (param) {
                          ...
                          return eventLogReplay(id).then(function (history) {
                                      ...
                                      console.log("finished eventLogReplay for id " + id);
                                      Belt_Array.mapWithIndex(topicItems, (function (idx, param) {
                                              ...
                                              var commandStr = JSON.stringify(Message$Reventless.command$prime_encode(Spec.Id.t_encode, Spec.command_encode, command));
                                              var idx$1 = idx + 1 | 0;
                                              console.log("CommandTopic: handling command " + idx$1 + "/" + count + ": " + commandName + "(" + id + ") ref: " + param.reference + ", complete command: " + commandStr);
                                      ...
                                      return Belt_Array.reduce(match[1], Promise.resolve({
                                                          TAG: /* Ok */0,
                                                          _0: [
                                                  ...
                                                  console.log("Aggregate.handleCommands(" + id + "): " + eventCount + " Event(s) generated:", Belt_Array.map(generatedEvents$prime, (function (event$prime) {
                                                  ...
                                                  return eventLogAppend(history.length, id, generatedEvents$prime).then(function (result) {
                                                              ...
                                                              console.log("finished eventLogAppend for id " + id);
  ...
  var make = function (opts, param) {
    ...
    return new Component(prim, prim$1, construct, opts);
  };
  return {
          Spec: Spec,
          make: make,
