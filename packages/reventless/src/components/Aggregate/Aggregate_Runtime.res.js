...
function Make(Spec, Behaviour, Ops) {
  var errorHandler = function (error, command, context) {
    ...
    var id = context.id;
    Logger$Reventless.error("File \"Aggregate_Runtime.res\", line 27, characters 11-18", undefined, undefined, "Behaviour error " + errorJson + " in " + Spec.name + "(" + id + "): Command: ", commandJsonStr);
    return [];
  };
  ...
  var handleCommands = async function (allTopicItems) {
    ...
    return Belt_Array.concatMany(await Promise.all(Belt_Array.map(groupTopicItemsById(allTopicItems), (async function (param) {
                              ...
                              if (stateO !== undefined) {
                                ...
                                try {
                                  ...
                                  if ($$event.RE_EXN_ID === Message$Reventless.InvalidEvent) {
                                    Logger$Reventless.error("File \"Aggregate_Runtime.res\", line 89, characters 34-41", undefined, undefined, "Behaviour.execute: InvalidEvent", $$event._1);
                                    generatedEvents = [];
                                  } else {
                                    throw $$event;
                                  }
                          ...
                          if (events.length !== 0) {
                            ...
                            if (match$1.TAG === "Ok") {
                              Logger$Reventless.debug("File \"Aggregate_Runtime.res\", line 167, characters 30-37", undefined, undefined, "finished eventLogAppend for id", Spec.Id.toString(id));
                            ...
                            Logger$Reventless.error("File \"Aggregate_Runtime.res\", line 170, characters 30-37", undefined, undefined, "failed eventLogAppend for id", Spec.Id.toString(id));
                            return Belt_Array.map(references, (function (reference) {
                                          return {
                                                  TAG: "Error",
                                                  _0: reference
                          ...
                          Logger$Reventless.debug("File \"Aggregate_Runtime.res\", line 153, characters 19-26", undefined, undefined, "handleCommands(" + Spec.Id.toString(id) + ")", "no Event generated");
                          return Belt_Array.map(references, (function (reference) {
                                        return {
                                                TAG: "Ok",
                                                _0: reference
