  ...
  if (typeof match !== "number" && !match.tag) {
    switch (match[0]) {
      ...
      case "NotCountedOnStorage" :
          ...
          if (!v0.tag) {
            return /* Ok */Block.__(0, [/* NotCountedOnStorage */Block.__(2, [v0[0]])]);
          }
          var e = v0[0];
      ...
      case "NotDeletedFromStorage" :
          ...
          if (!v0$1.tag) {
            return /* Ok */Block.__(0, [/* NotDeletedFromStorage */Block.__(3, [v0$1[0]])]);
          }
          var e$1 = v0$1[0];
          return /* Error */Block.__(1, [{
                      path: "[0]" + e$1.path,
      ...
      case "NotLoadedFromStorage" :
          ...
          if (!v0$2.tag) {
            return /* Ok */Block.__(0, [/* NotLoadedFromStorage */Block.__(1, [v0$2[0]])]);
          }
          var e$2 = v0$2[0];
          return /* Error */Block.__(1, [{
                      path: "[0]" + e$2.path,
      ...
      case "NotSavedToStorage" :
          ...
          if (!v0$3.tag) {
            return /* Ok */Block.__(0, [/* NotSavedToStorage */Block.__(0, [v0$3[0]])]);
          }
          var e$3 = v0$3[0];
          return /* Error */Block.__(1, [{
                      path: "[0]" + e$3.path,
...
function Make(Config, Spec, $$Storage, Resolvers) {
        ...
        return storage.load(Curry._1(Spec.Id.toString, id)).then((function (result) {
                      return Promise.resolve(Belt_Result.map(result, (function (states) {
                                        return Belt_List.flatten(Belt_List.map(states, (function (param) {
                                                          ...
                                                          console.log("QueryDb: Error: Couldn\'t decode state for " + (String(id) + (": " + (String(state[0]) + ""))));
                                                          return /* [] */0;
                                                        })));
                                      })));
                    }));
  ...
  var make = function (ttl, opts, param) {
    ...
    var prim$3 = Config.api;
    var prim$4 = Config.apiRole;
    return new Component.default(prim, prim$1, prim$2, opts, prim$3, prim$4);
  };
  return {
          Spec: Spec,
          make: make,
