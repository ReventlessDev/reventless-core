let make = (~name as _, ~opts) => {
  ...
  Scheduler.{
    ...
    createSchedule:
      role->AdapterAws_ScheduledPublisher_CloudWatchEvents_Runtime.createSchedule,
    deleteSchedule: AdapterAws_ScheduledPublisher_CloudWatchEvents_Runtime.deleteSchedule,
  };
};
