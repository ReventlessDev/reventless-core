type plugin;
[@bs.get] external getServices: plugin => Js.Dict.t(Service.t) = "services";
[@bs.get] external getTasks: plugin => Js.Dict.t(Task.t) = "tasks";
[@bs.get]
external getEventMapper: plugin => Js.Dict.t(EventMapper.t) = "eventMappers";
