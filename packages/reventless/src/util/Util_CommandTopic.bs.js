...
function setConnectorResource(resources, resource, name) {
  return Curry._1((function (param) {
                  ...
                  })(connector)(ComponentType$Reventless.name(name, /* CommandTopic */4)), resource);
}
...
function getConnectorResource(resources, name) {
  return (function (param) {
              ...
              })(connector)(ComponentType$Reventless.name(name, /* CommandTopic */4));
}
...
function setConnectorFunc(resources, resource, name) {
  return Curry._1((function (param) {
                  ...
                  })(func)(ComponentType$Reventless.name(name, /* CommandTopic */4)), resource);
}
...
function getConnectorFunc(resources, name) {
  return (function (param) {
              ...
              })(func)(ComponentType$Reventless.name(name, /* CommandTopic */4));
}
