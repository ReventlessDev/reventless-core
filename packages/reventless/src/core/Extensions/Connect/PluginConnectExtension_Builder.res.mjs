...
import * as SNS$AwsSdk from "@reventless/rescript-aws-sdk/src/SNS.res.mjs";
import * as Stdlib_Array from "@rescript/runtime/lib/es6/Stdlib_Array.js";
import * as AWS$Reventless from "../../../util/AWS.res.mjs";
...
function Make(Spec) {
  let subscribe = async (action, extensionPointName, eventTopic, pluginId, eventCollector) => {
    let eventTopicName = AWS$Reventless.arn2Name(eventTopic);
    let eventCollectorName = AWS$Reventless.arn2Name(eventCollector);
