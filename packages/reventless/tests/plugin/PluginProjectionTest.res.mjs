...
import * as ProjectionTest$Reventless from "../../test-helper/ProjectionTest.res.mjs";
import * as PluginProjection$Reventless from "../../src/core/ReadModels/Plugin/PluginProjection.res.mjs";

let PluginProjectionTest = ProjectionTest$Reventless.Make(PluginProjection$Reventless.PluginMapping);
