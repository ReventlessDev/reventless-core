...
Jest.describe("Logger", (function () {
        ...
        Jest.describe("commandJsonsToLogMessage", (function () {
                ...
                Jest.test("simple", (function () {
                        ...
                        var metaStr = JSON.stringify(Message$Reventless.encode(meta, Message$Reventless.metaSchema));
                ...
                Jest.test("complex", (function () {
                        ...
                        var expected2 = "2/2: Connect(1): {\"command\":{\"TAG\":\"Connect\",\"_0\":{\"id\":\"id\",\"name\":\"testName\",\"version\":\"testVersion\",\"extensionPoints\":[{\"name\":\"testExtensionPoint\",\"commandTopic\":\"testCommandTopic\",\"eventTopic\":\"testEventTopic\"}],\"extensions\":[{\"name\":\"testExtension\",\"extensionPointName\":\"testExtensionPoint\"}],\"eventCollector\":\"testEventCollector\"}},\"meta\":" + metaStr + ",\"id\":1}";
                        return Jest.Expect.toEqual(Jest.Expect.expect(Logger$Reventless.commandJsonsToLogMessages(arr)), [
                                    expected1,
                                    expected2
                                  ]);
