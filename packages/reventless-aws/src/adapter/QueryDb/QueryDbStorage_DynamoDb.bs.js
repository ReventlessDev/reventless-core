...
function make(name, indexes, subIdField, ttl, api, apiRole, opts) {
  var table = Util_DynamoDb$ReventlessAws.makeTable(attributes(subIdField, indexes), Caml_option.some(globalSecondaryIndexes(indexes)), ttl, subIdField, Caml_option.some(Js_dict.fromArray([
                [
                  "Name",
                  name
                ],
