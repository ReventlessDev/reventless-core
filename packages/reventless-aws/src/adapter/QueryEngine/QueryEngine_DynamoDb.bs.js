...
async function queryByTableName(tableName, keyOpt, id, subIdConfig, filterConfigsOpt, ascendingOpt, limitOpt, param) {
  ...
  var params_ExpressionAttributeNames = Caml_option.some(attributeNames);
  var params_ExpressionAttributeValues = Caml_option.some(attributeValues);
  ...
  var result;
  try {
    result = await DynamoDb_DocumentClient$AwsSdk.queryRecursive(undefined, params, undefined);
  }
  catch (raw_err){
...
async function scanByTableName(tableName, filterConfigs, limit) {
  ...
  var result;
  try {
    result = await DynamoDb_DocumentClient$AwsSdk.scanRecursive(undefined, params, undefined);
  }
  catch (raw_e){
