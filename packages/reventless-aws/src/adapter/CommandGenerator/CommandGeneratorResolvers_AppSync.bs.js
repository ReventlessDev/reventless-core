...
function make(name, api, fields, commandGenerator, opts) {
  ...
  var resolvers = Belt_Array.map(fields, (function (field) {
          ...
          Logger$Reventless.logOutput("File \"CommandGeneratorResolvers_AppSync.re\", line 123, characters 15-22", undefined, undefined, undefined, "datasource-name (" + name + ")", dataSource.name);
