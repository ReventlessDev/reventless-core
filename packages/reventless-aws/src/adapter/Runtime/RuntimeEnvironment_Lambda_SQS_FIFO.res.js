...
function make(name, channelResources, handleJsons, opts) {
  var lambdaResource = Adapter$Reventless.outputToResource(Output$Pulumi.flatMap(Util_SQS_FIFO$ReventlessAws.fromResource(Util_SQS_FIFO$ReventlessAws.findResource(channelResources)), (function (queue) {
