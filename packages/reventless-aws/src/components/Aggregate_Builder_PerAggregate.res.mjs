...
import * as Aggregate_Builder$Reventless from "@reventless/reventless/src/components/Aggregate/Aggregate_Builder.res.mjs";
import * as RuntimeEnvironment_Lambda$ReventlessAws from "../adapter/Runtime/RuntimeEnvironment_Lambda.res.mjs";
import * as AggregateRuntime_Builder_Single$Reventless from "@reventless/reventless/src/adapter/Runtime/AggregateRuntime_Builder_Single.res.mjs";
