...
module Catalog = ReventlessdevExampleAggregateCatalog.CatalogPlugin.Make(Platform)
module Ordering = ReventlessdevExampleAggregateOrdering.OrderingPlugin.Make(Platform)
