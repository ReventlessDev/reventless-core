...
import * as Product$ReventlessdevAggregateExampleCatalog from "../../src/Aggregate/Product.res.mjs";
import * as ProductBehavior$ReventlessdevAggregateExampleCatalog from "../../src/Aggregate/ProductBehavior.res.mjs";
