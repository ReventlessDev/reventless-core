...
import * as CategoriesProjections$ReventlessdevExampleAggregateCatalog from "../../src/ReadModel/CategoriesProjections.res.mjs";

let include = ProjectionTest$ReventlessInMemory.Make(CategoriesProjections$ReventlessdevExampleAggregateCatalog.CategoryMapping);
