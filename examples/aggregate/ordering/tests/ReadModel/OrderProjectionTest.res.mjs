...
import * as OrdersProjections$ReventlessdevAggregateExampleOrdering from "../../src/ReadModel/OrdersProjections.res.mjs";

let include = ProjectionTest$Reventless.Make(OrdersProjections$ReventlessdevAggregateExampleOrdering.OrderMapping);
