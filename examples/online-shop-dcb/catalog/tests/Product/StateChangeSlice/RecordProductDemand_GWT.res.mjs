...
import * as RecordProductDemand$CatalogPlugin from "../../../src/Product/StateChangeSlice/RecordProductDemand.res.mjs";
import * as RecordProductDemand_Behavior$CatalogPlugin from "../../../src/Product/StateChangeSlice/RecordProductDemand_Behavior.res.mjs";
...
describe("RecordProductDemand StateChangeSlice", () => {
  ...
  test("RecordDemand for new orderId on existing product produces ProductDemandRecorded", () => thenEvent(whenCmd(givenEvents([{
      TAG: "ProductDemandRecorded",
      orderId: "order-1"
    }]), {
    TAG: "RecordDemand",
  ...
  test("RevokeDemand for unrecorded orderId on existing product produces no events (idempotent)", () => thenNoEvent(whenCmd(givenEvents([{
      TAG: "ProductDemandRecorded",
      orderId: "order-1"
    }]), {
    TAG: "RevokeDemand",
