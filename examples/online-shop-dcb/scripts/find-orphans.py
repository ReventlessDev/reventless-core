...
Background
----------
The online-shop-dcb stack is split into three Pulumi projects:
  examples/online-shop-dcb/platform-aws/   (admin, scheduler, shared API)
  examples/online-shop-dcb/catalog-aws/    (Catalog plugin infra)
  examples/online-shop-dcb/ordering-aws/   (Ordering plugin infra)
...
-----
  ...
  cd examples/online-shop-dcb/platform-aws && pulumi stack export --file /tmp/state-platform.json
  cd examples/online-shop-dcb/catalog-aws  && pulumi stack export --file /tmp/state-catalog.json
  cd examples/online-shop-dcb/ordering-aws && pulumi stack export --file /tmp/state-ordering.json
