...
function Make(Platform) {
  ...
  let make = () => Platform.Plugin.make("Ordering", 5, [Orders_ExtensionPoint], [Products_Extension], [
    ...
    CustomersReadModel,
    OrdersReadModel
  ], [OrderNotificationsTask], undefined, undefined, undefined, undefined, undefined, undefined, undefined, Stdlib_Option.map(process.env.ORDERING_UI_BUNDLE_URL, url => Platform.Plugin.makeAutoUIManifest(url, "Ordering", pluginStructure, ["platform-summary"], ["resource-detail"])), pluginStructure, undefined);
  return {
