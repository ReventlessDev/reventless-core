 ...
 *   - Pulumi stack deployed (run from examples/online-shop-aggregates/platform-aws/)
 *   - Fill in the endpoint constants below from your deployed stack outputs:
...
// ─── Config ──────────────────────────────────────────────────────────────────
// TODO: replace with the deployed-stack endpoints (see prerequisites above).

const REGION = "eu-west-1";
const EVENTS_HTTP_HOST = "<EVENTS_API_ID>.appsync-api.eu-west-1.amazonaws.com";
const EVENTS_REALTIME_HOST = "<EVENTS_API_ID>.appsync-realtime-api.eu-west-1.amazonaws.com";
const DOMAIN_API_ENDPOINT = "https://<DOMAIN_API_ID>.appsync-api.eu-west-1.amazonaws.com/graphql";
const DOMAIN_API_ID = "<DOMAIN_API_ID>";
