...
let dcbSliceSchemas: array<Reventless.DcbTag.sliceSchemas> = [
  {
    ...
    moduleUrl: CancelOrder.moduleUrl,
  },
  {
    ...
    moduleUrl: EmailVerificationChallenges.moduleUrl,
  },
  {
    ...
    eventSchema: NotificationPreferences.eventSchema->S.castToUnknown,
    moduleUrl: NotificationPreferences.moduleUrl,
  },
  {
    name: NotificationSourceClaims.name,
    commandSchema: NotificationSourceClaims.commandSchema->S.castToUnknown,
    consumedEventSchema: NotificationSourceClaims.consumedEventSchema->S.castToUnknown,
    eventSchema: NotificationSourceClaims.eventSchema->S.castToUnknown,
    moduleUrl: NotificationSourceClaims.moduleUrl,
  },
  {
    ...
    moduleUrl: PlaceOrder.moduleUrl,
  },
  {
    name: ShipOrder.name,
  ...
  },
  {
    ...
    moduleUrl: SyncCatalogProduct.moduleUrl,
  },
]
...
module Make = (Platform: ReventlessInfra.Platform.T) => {
  ...
  module NotificationSourceClaimsSlice = Platform.StateChangeSlice.Make(
    NotificationSourceClaims,
    NotificationSourceClaims_Behavior,
  )
  ...
  module AvailableProductsStreamSlice = Platform.StateViewSliceStream.Make(
    AvailableProducts,
    AvailableProducts_Projection,
  )
  module NotificationDeliveriesStreamSlice = Platform.StateViewSliceStream.Make(
    NotificationDeliveries,
    NotificationDeliveries_Projection,
  )
  module NotificationSubscriptionsStreamSlice = Platform.StateViewSliceStream.Make(
    NotificationSubscriptions,
    NotificationSubscriptions_Projection,
  )
  ...
  module NotificationIntakeSlice = Platform.AutomationSlice.Make(
    NotificationIntake,
    NotificationIntake_Automation,
  )

  // OutboundTranslationSlices
  module AnnounceRecipientContactSlice = Platform.OutboundTranslationSlice.Make(
    AnnounceRecipientContact,
    AnnounceRecipientContact_Translation,
  )
  module GeocodeCustomerAddressSlice = Platform.OutboundTranslationSlice.Make(
    GeocodeCustomerAddress,
    GeocodeCustomerAddress_Translation,
  )
  module SendNotificationSlice = Platform.OutboundTranslationSlice.Make(
    SendNotification,
  ...
  let pluginStructure = Platform.Plugin.makePluginDefinition(
    ...
    ~stateViewSlices=[
      ...
      module(NotificationDeliveriesStreamSlice),
      module(NotificationSubscriptionsStreamSlice),
    ...
    ~componentChapters=Dict.fromArray([
      ("AnnounceRecipientContact", "Notification"),
      ("AutoShipOrder", "Order"),
      ...
      ("NotificationSourceClaims", "Notification"),
  ...
  let make = () =>
    Platform.Plugin.make(
      ...
      ~componentRuntime=Dict.fromArray([
        ("Customers", {ReventlessInfra.RuntimeHints.memorySize: Some(2048), timeout: None}),
        ("Customer", {ReventlessInfra.RuntimeHints.memorySize: Some(1536), timeout: None}),
        ("PlaceOrder", {ReventlessInfra.RuntimeHints.memorySize: Some(768), timeout: Some(60)}),
        ("Orders", {ReventlessInfra.RuntimeHints.memorySize: Some(1024), timeout: None}),
      ]),
