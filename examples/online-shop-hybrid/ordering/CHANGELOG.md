...
* **example:** an order's list says where the order has got to ([a1b3a81](https://github.com/ReventlessDev/reventless-core/commit/a1b3a81befb64af25371d189c22fde07c72b7b3d))
...
# 1.0.0-alpha.231 (2026-09-04)

### Features

* **notifications:** a delivery row names what it was about, not where it was sent ([65c01c6](https://github.com/ReventlessDev/reventless-core/commit/65c01c6b1b982880364c952266eab4294a824108))
* **notifications:** a rule says how it goes out, and the relay sends only its half ([cbcb992](https://github.com/ReventlessDev/reventless-core/commit/cbcb99207597830aa955154a0833aac2205a8e2f))
* **notifications:** a second producer can take over one stream of occurrences ([3050637](https://github.com/ReventlessDev/reventless-core/commit/3050637c8af69083c528030f2c59b04065ab8c2f))
...
* **traits:** a misspelled stand-down event passed the conformance suite ([f729e70](https://github.com/ReventlessDev/reventless-core/commit/f729e704e46f5f2ab6d7fe5f928d14b44c2862d8))
### Features
...
* **traits:** add the address-geocoding trait and bind Customer to its conformance suite ([66ab2a6](https://github.com/ReventlessDev/reventless-core/commit/66ab2a6364a68cce6f21682b6f1e22ec13dbbb73))
* **traits:** let a host splice the geocoding graft's commands too ([4c0ab62](https://github.com/ReventlessDev/reventless-core/commit/4c0ab6275af836c426a000212e56373ef05df3eb))
* **traits:** let a host splice the geocoding graft's events instead of copying them ([6f3db04](https://github.com/ReventlessDev/reventless-core/commit/6f3db04d14e73565baadcf059234720c9b8b7d8a))
* **traits:** package the notification competency ([480993b](https://github.com/ReventlessDev/reventless-core/commit/480993b007ed4cb7fc1c98feeb750655df9f9f16))
* **traits:** write the geocoding graft instead of transcribing it ([269118a](https://github.com/ReventlessDev/reventless-core/commit/269118a204beafd652b910df5d5ce7f068b74f47))
