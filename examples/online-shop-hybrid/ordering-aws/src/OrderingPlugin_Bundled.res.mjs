...
import * as ExtensionPoint_Builder_Bundled$ReventlessAws from "@reventlessdev/reventless-aws/src/components/ExtensionPoint_Builder_Bundled.res.mjs";
import * as Aggregate_Builder_Single_Bundled$ReventlessAws from "@reventlessdev/reventless-aws/src/components/Aggregate_Builder_Single_Bundled.res.mjs";
import * as ReadModel_Builder_Single_Bundled$ReventlessAws from "@reventlessdev/reventless-aws/src/components/ReadModel_Builder_Single_Bundled.res.mjs";
...
function Make(Platform) {
  ...
  let CustomerAggregate = Aggregate_Builder_Single_Bundled$ReventlessAws.Make({
  ...
  let CustomerReadModel = ReadModel_Builder_Single_Bundled$ReventlessAws.Make({
    Id: Id$Reventless.$$String,
    name: CustomersReadModel$OrderingPlugin.name,
    stateSchema: CustomersReadModel$OrderingPlugin.stateSchema,
  ...
  let specModulePath$2 = Util_Bundle$ReventlessAws.resolveModule(orderingSpecPkg + "/OrdersExtensionPoint.res.mjs");
  ...
  let OrdersExtensionPointMaker = ExtensionPoint_Builder_Bundled$ReventlessAws.Make(OrdersExtensionPoint$OrderingSpec)({
    mappings: mappings$2
  })({
