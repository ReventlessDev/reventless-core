...
module Make = (
  ...
  module CustomerReadModel = ReventlessAws.ReadModel_Builder_Single_Bundled.Make(
  ...
  module OrdersExtensionPointMaker = ReventlessAws.ExtensionPoint_Builder_Bundled.Make(
    OrderingSpec.OrdersExtensionPoint,
    OrdersEPMappings,
    {
      let specModulePath = resolveModule(
