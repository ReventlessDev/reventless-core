...
function Make(Platform) {
  ...
  let CategoryAggregate = Aggregate_Builder_Single_Bundled$ReventlessAws.Make({
  ...
  let CategoryReadModel = ReadModel_Builder_Single_Bundled$ReventlessAws.Make({
    Id: Id$Reventless.$$String,
    name: CategoriesReadModel$CatalogPlugin.name,
    stateSchema: CategoriesReadModel$CatalogPlugin.stateSchema,
  ...
  let specModulePath$2 = Util_Bundle$ReventlessAws.resolveModule(catalogSpecPkg + "/ProductsExtensionPoint.res.mjs");
  ...
  let ProductsExtensionPointMaker = ExtensionPoint_Builder_Bundled$ReventlessAws.Make(ProductsExtensionPoint$CatalogSpec)({
    mappings: mappings$1
  })({
