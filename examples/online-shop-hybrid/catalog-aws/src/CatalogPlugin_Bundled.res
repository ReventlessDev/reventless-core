...
module Make = (
  ...
  module CategoryReadModel = ReventlessAws.ReadModel_Builder_Single_Bundled.Make(
  ...
  module ProductsExtensionPointMaker = ReventlessAws.ExtensionPoint_Builder_Bundled.Make(
    CatalogSpec.ProductsExtensionPoint,
    ProductsEPMappings,
    {
      let specModulePath = resolveModule(
