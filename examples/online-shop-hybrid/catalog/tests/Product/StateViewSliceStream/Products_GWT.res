...
describe("Products StateViewSliceStream", () => {
  test("ProductAdded creates a row", () =>
    ...
    ->thenStateWithId(
      "p1",
      {productId: "p1", name: "Laptop", description: "x", price: eur(999.99), imageUrl: "/uploads/3e7b41c8-5a2d-4f60-8c19-77b0d4e6a912/p1.jpg", categoryId: "cat1"},
    )
  )
  ...
  test("ProductNameChanged updates the name", () =>
    ...
    ->thenStateWithId(
      "p1",
      {productId: "p1", name: "Gaming Laptop", description: "x", price: eur(999.99), imageUrl: "/uploads/3e7b41c8-5a2d-4f60-8c19-77b0d4e6a912/p1.jpg", categoryId: "cat1"},
    )
  )
  ...
  test("ProductDescriptionChanged updates the description", () =>
    ...
    ->thenStateWithId(
      "p1",
      {productId: "p1", name: "Laptop", description: "high-end", price: eur(999.99), imageUrl: "/uploads/3e7b41c8-5a2d-4f60-8c19-77b0d4e6a912/p1.jpg", categoryId: "cat1"},
    )
  )
  ...
  test("ProductPriceChanged updates the price", () =>
    ...
    ->thenStateWithId(
      "p1",
      {productId: "p1", name: "Laptop", description: "x", price: eur(899.99), imageUrl: "/uploads/3e7b41c8-5a2d-4f60-8c19-77b0d4e6a912/p1.jpg", categoryId: "cat1"},
    )
  )
  ...
  test("ProductImageChanged updates the image", () =>
    ...
    ->thenStateWithId(
      "p1",
      {productId: "p1", name: "Laptop", description: "x", price: eur(999.99), imageUrl: "/uploads/9c1f2a30-0b7e-4a11-9d33-6f0d2e5a8b41/p1-new.jpg", categoryId: "cat1"},
    )
  )
})
