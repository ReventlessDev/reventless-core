...
describe("Products StateViewSliceStream", () => {
  ...
  test("ProductArchived moves the product off the shelf", () =>
    ...
    ->thenStateWithId(
      "p1",
      {productId: "p1", name: "Laptop", description: "x", price: eur(999.99), imageUrl: "/uploads/3e7b41c8-5a2d-4f60-8c19-77b0d4e6a912/p1.jpg", categoryId: "cat1", shelfStatus: Archived},
    )
  )
  ...
  test("ProductDiscontinued is the end of the line", () =>
    ...
    ->thenStateWithId(
      "p1",
      {productId: "p1", name: "Laptop", description: "x", price: eur(999.99), imageUrl: "/uploads/3e7b41c8-5a2d-4f60-8c19-77b0d4e6a912/p1.jpg", categoryId: "cat1", shelfStatus: Discontinued},
    )
  )
})
