...
describe("ArchiveCategory StateChangeSlice", () => {
  test("archive on non-existent category returns CategoryNotFound", () => thenError(whenCmd(givenEvents([]), {
    TAG: "ArchiveCategory",
    categoryId: "c1"
  }), "CategoryNotFound"));
  test("archive on active category produces CategoryArchived", () => thenEvent(whenCmd(givenEvents(["CategoryAdded"]), {
    TAG: "ArchiveCategory",
    categoryId: "c1"
  }), {
