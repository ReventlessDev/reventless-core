...
describe("RenameCategory StateChangeSlice", () => {
  test("rename on non-existent category returns CategoryNotFound", () => thenError(whenCmd(givenEvents([]), {
    TAG: "RenameCategory",
    categoryId: "c1",
    name: "Consumer Electronics"
  }), "CategoryNotFound"));
  test("rename on active category produces CategoryRenamed", () => thenEvent(whenCmd(givenEvents([{
      TAG: "CategoryAdded",
      name: "Electronics"
    }]), {
    TAG: "RenameCategory",
