...
module UpdateProductNameMaker = ReventlessInMemory.StateChangeSlice_Builder.Make(UpdateProductName)
module UpdateProductDescriptionMaker = ReventlessInMemory.StateChangeSlice_Builder.Make(
  UpdateProductDescription,
)
module UpdateProductPriceMaker = ReventlessInMemory.StateChangeSlice_Builder.Make(UpdateProductPrice)
...
let _updateProductNameSlice =
  UpdateProductNameMaker.make(~dcbEventLog=eventLog, ~publishJsons=publishJsonsOutput)
let _updateProductDescriptionSlice =
  UpdateProductDescriptionMaker.make(~dcbEventLog=eventLog, ~publishJsons=publishJsonsOutput)
let _updateProductPriceSlice =
  UpdateProductPriceMaker.make(~dcbEventLog=eventLog, ~publishJsons=publishJsonsOutput)
