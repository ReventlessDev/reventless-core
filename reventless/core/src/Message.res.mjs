...
function toEventSchema$p(idSchema, eventSchema) {
  return _rawMemoize(idSchema, eventSchema, (idSchema, eventSchema) => Sury.object(s => ({
    id: s.f("id", idSchema),
...
function toCommandSchema$p(idSchema, commandSchema) {
  return _rawMemoize(idSchema, commandSchema, (idSchema, commandSchema) => Sury.object(s => ({
    id: s.f("id", idSchema),
    meta: s.f("meta", Message$Reventless.metaSchema),
...
function storedEventToFlatJson(stored, idSchema) {
  ...
  let withTags;
  if (tags !== undefined) {
    let tagsJson = Util_Sury$Reventless.toJson(tags, Sury.array(DcbTag$Reventless.tagSchema));
...
function flatJsonToStoredEvent(json, idSchema) {
  ...
  let tags = Stdlib_Option.map(dict["tags"], t => Util_Sury$Reventless.fromJson(t, Sury.array(DcbTag$Reventless.tagSchema)));
  return {
    id: id,
    position: position,
    event: event,
