...
function Make(RuntimeEnvironment) {
  return EventCollectorChannel => (QueryEngineAdapter => (ClonerRunner => (PlatformRuntimeBuilder => (DcbEventLogStorage => (DcbEventTopicPublisher => (DcbCommandTopicChannel => (DcbCommandTopicChannelAsync => (Config => {
    ...
    return {
      ...
      taskSideEffectGates: Builder_Helpers$ReventlessCore.taskSideEffectGates,
      taskSideEffectFinishFns: Builder_Helpers$ReventlessCore.taskSideEffectFinishFns,
      registerTaskSideEffectHandler: Builder_Helpers$ReventlessCore.registerTaskSideEffectHandler,
      finishTasks: Builder_Helpers$ReventlessCore.finishTasks,
