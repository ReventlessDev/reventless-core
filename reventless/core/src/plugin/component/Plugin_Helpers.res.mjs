...
import * as DcbEventLog$ReventlessCore from "../../components/DcbEventLog/DcbEventLog.res.mjs";
import * as EventMapper$ReventlessCore from "../../components/EventMapper/EventMapper.res.mjs";
...
import * as StateViewSlice$ReventlessCore from "../../components/StateViewSlice/StateViewSlice.res.mjs";
...
import * as InboundTranslationSlice$ReventlessCore from "../../components/InboundTranslationSlice/InboundTranslationSlice.res.mjs";
import * as OutboundTranslationSlice$ReventlessCore from "../../components/OutboundTranslationSlice/OutboundTranslationSlice.res.mjs";
...
function getRemoteStorageResources(pluginName, queryDbName) {
  let resources = Stdlib_Option.map(Util_StackRefs$ReventlessCore.get(pluginName), stackRef => {
    ...
    return readModelsOutput.apply(readModelsOpt => {
      ...
      try {
        let readModel = Sury.parseOrThrow(rawReadModel, ReadModel$ReventlessInterop.resolvedOutputsSchema);
