...
function queryableDefFromSpec(plugin, name, stateSchema, authorization, visibilityOpt, consumedEventTypesOpt, linkedWriteSideOpt, excludeFieldsOpt, chapter) {
  ...
  return {
    ...
    schema: encodeSchemaExcluding(stateSchema, excludeFields),
