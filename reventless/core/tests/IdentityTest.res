...
describe("Identity", () => {
  ...
  describe("hasGroup", () => {
    ...
    testSync(
      "returns true when group is present",
      () => {
    ...
    testSync(
      "returns false when group is absent",
      () => {
  ...
  describe("getClaim", () => {
    ...
    testSync(
      "returns Some for existing claim",
      () => {
    ...
    testSync(
      "returns None for missing claim",
      () => {
    ...
    testSync(
      "returns None when claims are absent",
      () => {
  ...
  describe("schema roundtrip", () => {
    testSync(
      "encode then decode preserves identity",
      () => {
        let identity: Reventless.Identity.t = {
          userId: "user-1",
          username: "alice",
    ...
    testSync(
      "roundtrip with Custom provider",
      () => {
        let identity: Reventless.Identity.t = {
          userId: "ext-1",
          username: "external",
    ...
    testSync(
      "roundtrip without optional claims",
      () => {
        let identity: Reventless.Identity.t = {
          userId: "user-3",
          username: "charlie",
...
describe("RequestContext", () => {
  describe("test() constructor", () => {
    testSync(
      "defaults to anonymous identity",
      () => {
  ...
  describe("getClaim", () => {
    testSync(
      "returns claim value when present",
      () => {
