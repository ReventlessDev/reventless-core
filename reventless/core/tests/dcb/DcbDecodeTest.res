...
describe("DcbDecode:", () => {
  describe("makeDecoder — payload-less", () => {
    let {Reventless.DcbDecode.decode: decode, eventTypes} = Reventless.DcbDecode.makeDecoder(
      consumedPayloadLessSchema,
    )

    testSync(
      "returns correct eventTypes",
      () => {
    ...
    testSync(
      "decodes ItemCreated as payload-less variant",
      () => {
        let result = decode(
    ...
    testSync(
      "decodes ItemArchived as payload-less variant",
      () => {
        let result = decode(
  ...
  describe("makeDecoder — partial projection", () => {
    let {Reventless.DcbDecode.decode: decode} = Reventless.DcbDecode.makeDecoder(
      consumedPartialSchema,
    )

    testSync(
      "decodes ItemCreated with only itemId field",
      () => {
        let result = decode(
          ~eventType="ItemCreated",
          ~data=Dict.fromArray([("itemId", JSON.String("i-1")), ("name", JSON.String("Test"))]),
    ...
    testSync(
      "decodes ItemRenamed with only itemId field",
      () => {
        let result = decode(
          ~eventType="ItemRenamed",
  ...
  describe("makeDecoder — full shape", () => {
    let {Reventless.DcbDecode.decode: decode} = Reventless.DcbDecode.makeDecoder(consumedFullSchema)

    testSync(
      "decodes ItemCreated with all fields",
      () => {
        let result = decode(
          ~eventType="ItemCreated",
          ~data=Dict.fromArray([("itemId", JSON.String("i-1")), ("name", JSON.String("Test"))]),
    ...
    testSync(
      "decodes ItemRenamed with all fields",
      () => {
        let result = decode(
          ~eventType="ItemRenamed",
          ~data=Dict.fromArray([("itemId", JSON.String("i-1")), ("newName", JSON.String("New"))]),
    ...
    testSync(
      "decodes ItemArchived with all fields",
      () => {
        let result = decode(
          ~eventType="ItemArchived",
          ~data=Dict.fromArray([("itemId", JSON.String("i-1"))]),
