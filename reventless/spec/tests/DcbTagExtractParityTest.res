...
// schema-aware `S.reverseConvertToJsonOrThrow`. The two must feed the tag
...
describe("DcbTag.extractTags reverseConvert parity", () => {
  testSync("scalar string tag: reverse-json == stringify-json for extraction", () => {
    ...
    let r = v->S.reverseConvertToJsonOrThrow(Scalar.eventSchema)
  ...
  testSync("int tag", () => {
    ...
    let r = v->S.reverseConvertToJsonOrThrow(IntTag.eventSchema)
    let s = viaStringify(v)
  ...
  testSync("payload-less variant present in the union", () => {
    ...
    let r = v->S.reverseConvertToJsonOrThrow(PayloadLess.eventSchema)
    let s = viaStringify(v)
  ...
  testSync("plain object (non-union) event", () => {
    ...
    let r = v->S.reverseConvertToJsonOrThrow(PlainObject.eventSchema)
    let s = viaStringify(v)
  ...
  testSync("array tag expands per element (extractTagsFromJsonExpanded)", () => {
    ...
    let r = v->S.reverseConvertToJsonOrThrow(ArrayTag.commandSchema)
    let s = viaStringify(v)
  ...
  testSync("@as-renamed tagged field: reverseConvert feeds the serialized key", () => {
    ...
    let r = v->S.reverseConvertToJsonOrThrow(Renamed.eventSchema)
