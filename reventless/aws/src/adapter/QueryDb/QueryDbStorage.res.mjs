...
function make(name, indexes, subIdField, ttl, api, apiRole, owner, opts) {
  if (QueryDbBackend$ReventlessAws.isPostgresFor(name)) {
    return QueryDbStorage_Postgres$ReventlessAws.make(name, indexes, subIdField, ttl, api, apiRole, owner, opts);
  } else {
    return QueryDbStorage_DynamoDb$ReventlessAws.make(name, indexes, subIdField, ttl, api, apiRole, owner, opts);
  }
}
...
function make$1(name, indexes, subIdField, ttl, api, apiRole, owner, opts) {
  if (QueryDbBackend$ReventlessAws.isPostgresFor(name)) {
    QueryDbBackend$ReventlessAws.postgresStreamRegistry.add(name);
    return QueryDbStorage_Postgres$ReventlessAws.make(name, indexes, subIdField, ttl, api, apiRole, owner, opts);
  } else {
    return QueryDbStorage_DynamoDbStream$ReventlessAws.make(name, indexes, subIdField, ttl, api, apiRole, owner, opts);
  }
}
