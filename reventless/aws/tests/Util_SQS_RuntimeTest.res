...
describe("Util_SQS_Runtime.safeGroupId", () => {
  ...
  testSync("returns SHA-256 hex (64 chars) when id exceeds 128 chars", () => {
  ...
  testSync("boundary: 128-char id is returned unchanged", () => {
  ...
  testSync("boundary: 129-char id is hashed", () => {
