// Domain (plugin-facing) in-memory MCP server — singleton.
...
//
// Note: the old MCP_Server.res has been renamed to DomainMCP_Server.res.
// MCP_Server.res now re-exports this module for backwards compatibility.
...
type diagnostics = MCP_ServerInstance.diagnostics
...
// Exposes this singleton as a MCP_ServerInstance.t for resolveTargetMCP() in Platform.res.
let asInterface: MCP_ServerInstance.t = {
  registerTool,
  registerResource,
