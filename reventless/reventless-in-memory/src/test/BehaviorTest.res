// Spec module type for BehaviorTest — only types accessible from reventless-spec
// so example packages (which don't depend on reventless directly) can use this module.
