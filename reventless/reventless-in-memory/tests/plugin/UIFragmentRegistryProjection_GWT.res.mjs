...
let registeredState_remoteEntryUrl = Plugin_Fixtures$ReventlessInMemory.uiManifest.remoteEntryUrl;

let registeredState_panels = Plugin_Fixtures$ReventlessInMemory.uiManifest.panels;

let registeredState_pages = Plugin_Fixtures$ReventlessInMemory.uiManifest.pages;
...
UIFragmentRegistryProjectionTest.describe("UIFragmentRegistryProjection:", () => {
  ...
  UIFragmentRegistryProjectionTest.test("UIFragmentUpdated updates manifest fields", undefined, () => UIFragmentRegistryProjectionTest.thenState(UIFragmentRegistryProjectionTest.whenEvent(UIFragmentRegistryProjectionTest.givenEvents([{
    ...
    _0: {
      pluginId: Plugin_Fixtures$ReventlessInMemory.pluginDefinition.id,
      previousManifest: Plugin_Fixtures$ReventlessInMemory.uiManifest,
