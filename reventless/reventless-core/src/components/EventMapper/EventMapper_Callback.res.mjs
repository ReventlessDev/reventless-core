...
function MakeEventCollectorHandler(Ops) {
  ...
  let handleJsonEvents = stream => Effect.Stream.runForEach(stream, eventJson$p => Effect.Effect.promise(async () => {
    let match = await Ops.commonEventsHandler([eventJson$p]);
