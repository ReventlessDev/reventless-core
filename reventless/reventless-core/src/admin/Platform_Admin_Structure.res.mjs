...
let activateCommand_schema = encodeSchema(PluginBaseFragment$ReventlessCore.activateArgsSchema);
...
let deactivateCommand_schema = encodeSchema(PluginBaseFragment$ReventlessCore.deactivateArgsSchema);
...
/* activateCommand Not a pure module */
