...
function encodeEvent(event) {
  let json = Util_Sury$Reventless.toJson(event, DcbFixtures$ReventlessCore.TestEventLogSpec.eventSchema);
...
function decodeEvent(raw) {
  ...
  return Util_Sury$Reventless.fromJson(json, DcbFixtures$ReventlessCore.TestEventLogSpec.eventSchema);
}
