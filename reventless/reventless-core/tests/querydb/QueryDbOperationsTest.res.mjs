...
describe("QueryDb_Operations:", () => {
  ...
  describe("saveBatch", () => {
    test("saves multiple states", async () => {
      ...
      let r1 = await Effect.Effect.runPromise(Stream.runCollect(Ops.loadStream("item-1")));
      let r2 = await Effect.Effect.runPromise(Stream.runCollect(Ops.loadStream("item-2")));
      expect([
        r1.length !== 0,
        r2.length !== 0
      ]).toEqual([
