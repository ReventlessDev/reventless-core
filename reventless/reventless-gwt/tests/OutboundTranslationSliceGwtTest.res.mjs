...
import * as OutboundTranslationSlice_GWT$ReventlessGwt from "../src/OutboundTranslationSlice_GWT.res.mjs";
...
let include = OutboundTranslationSlice_GWT$ReventlessGwt.Make(SendTrackingEmailSlice);
