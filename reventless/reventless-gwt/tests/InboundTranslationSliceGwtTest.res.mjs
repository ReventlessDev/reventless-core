...
import * as InboundTranslationSlice_GWT$ReventlessGwt from "../src/InboundTranslationSlice_GWT.res.mjs";
...
let include = InboundTranslationSlice_GWT$ReventlessGwt.Make(PaymentWebhookSlice);
