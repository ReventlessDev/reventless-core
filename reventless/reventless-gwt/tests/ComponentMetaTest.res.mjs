...
describe("ComponentMeta.componentOfTestFile", () => {
  test("derives kind + name from a slice GWT test path", async () => {
  ...
  test("derives a ReadModel component", async () => {
  ...
  test("strips the GwtTest marker shape too", async () => {
  ...
  test("returns None outside a recognised kind folder", async () => {
...
describe("ComponentMeta.componentOfSrcFile", () => {
  test("collapses a spec file to its component", async () => {
  ...
  test("collapses a behavior body file to the same component", async () => {
  ...
  test("strips the longest body suffix first (ExtensionPointMapping)", async () => {
