...
import * as Aggregate_Builder$Reventless from "@reventlessdev/reventless-core/src/components/Aggregate/Aggregate_Builder.res.mjs";
import * as RuntimeEnvironment_Lambda$ReventlessAws from "../adapter/Runtime/RuntimeEnvironment_Lambda.res.mjs";
import * as AggregateRuntime_Builder_Single$Reventless from "@reventlessdev/reventless-core/src/adapter/Runtime/AggregateRuntime_Builder_Single.res.mjs";
...
let AggregateRuntimeBuilder = AggregateRuntime_Builder_Single$Reventless.Make({
