...
function Make(Spec) {
  return Behavior => (EventMappings => (Config => {
    ...
    let make = (api, opts) => {
      ...
      AggregateRuntime_Builder_Micro$ReventlessAws.registerAggregate(Spec.name, Config.specModulePath, Config.behaviorModulePath, eventLogTableName, Config.mappingsModulePath);
      return aggregate;
    };
