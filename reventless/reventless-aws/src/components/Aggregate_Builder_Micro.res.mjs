...
import * as AggregateRuntime_Builder_Micro$Reventless from "@reventlessdev/reventless-core/src/adapter/Runtime/AggregateRuntime_Builder_Micro.res.mjs";
...
let AggregateRuntimeBuilder = AggregateRuntime_Builder_Micro$Reventless.Make({
