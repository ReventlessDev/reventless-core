...
let patchSpecId = ((specModule) => ({ ...specModule, Id: specModule.Id || IdString }));

function makeTableRef(name) {
  return {
    name: name,
    hashKey: "id"
  };
...
let scanByTableName = (async function(tableName, filterConfigs, limit) {
