    ...
    specs.forEach(spec => {
      ...
      if (info !== undefined) {
        ...
        if (match$3 !== undefined) {
          ...
          let match$4 = Util_Bundle$ReventlessAws.buildCodeArchive("@reventlessdev/reventless-aws/src/adapter/Runtime/EventMapperEntryPoint.mjs", evtMapperPackageDirs);
