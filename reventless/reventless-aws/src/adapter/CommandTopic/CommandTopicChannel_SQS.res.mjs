...
function make(name, opts) {
  ...
  return {
    ...
    publishJsons: Util_SQS$ReventlessAws.toRuntimeQueueOutput(queue).apply(runtimeQueue => CommandTopicChannel_SQS_Runtime$ReventlessAws.publishJsons(runtimeQueue, "SQS")),
