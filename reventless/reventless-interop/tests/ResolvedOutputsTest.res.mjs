...
Jest.describe("DCB interop types — round-trip serialization", () => {
  Jest.test("DcbEventLog.resolvedOutputs round-trips", () => {
  ...
  Jest.test("StateChangeSlice.resolvedOutputs round-trips", () => {
    let original = {
      resources: [resource]
    };
  ...
  Jest.test("StateViewSlice.resolvedOutputs round-trips", () => {
    let original_resources = [resource];
    let original = {
      resources: original_resources,
      queryDb: queryDb
  ...
  Jest.test("AutomationSlice.resolvedOutputs round-trips", () => {
    let original_resources = [resource];
    let original = {
      resources: original_resources,
      queryDb: queryDb
  ...
  Jest.test("OutboundTranslationSlice.resolvedOutputs round-trips", () => {
    let original_resources = [resource];
    let original = {
      resources: original_resources,
      queryDb: queryDb
  ...
  Jest.test("InboundTranslationSlice.resolvedOutputs round-trips", () => {
    let original_resources = [resource];
    let original = {
      resources: original_resources,
      queryDb: queryDb
  ...
  Jest.test("QueryDb.resolvedOutputs round-trips", () => {
    let original = {
      resources: [resource]
    };
...
Jest.describe("Aggregate interop types — round-trip serialization", () => {
  Jest.test("Aggregate.resolvedOutputs round-trips (without eventMapper)", () => {
    let original = {
      name: "Customer",
  ...
  Jest.test("Aggregate.resolvedOutputs round-trips (with eventMapper)", () => {
...
Jest.describe("Plugin.resolvedOutputs — round-trip with DCB fields", () => {
  Jest.test("minimal plugin (no optional fields) round-trips", () => {
    let original = {
      id: "test@1.0",
      version: "1.0.0"
    };
  ...
  Jest.test("plugin with readModels round-trips", () => {
  ...
  Jest.test("plugin with DCB slices round-trips", () => {
  ...
  Jest.test("plugin with aggregates round-trips", () => {
    let agg = {
      name: "Customer",
      commandGenerator: commandGeneratorOutputs,
      commandTopic: commandTopicOutputs,
  ...
  Jest.test("plugin with all fields round-trips", () => {
    let ep_commandTopic = {
      resources: [resource]
    };
    let ep = {
  ...
  Jest.test("minimal plugin without optional fields round-trips", () => {
    let original = {
      id: "empty@1.0",
      version: "1.0.0"
    };
