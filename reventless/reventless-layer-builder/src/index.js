...
export function build(opt) {
    const { sourcePackageName, sourcePackageVersion, pathToLayerData, pathToSavedDependencies, excludeScopes, excludeModules, postProcess, registryOpts } = opt;
